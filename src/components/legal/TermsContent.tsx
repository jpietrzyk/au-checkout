  ...
  return (
    <>
      ...
      <p>
        ...
        Serwisu i sprzedawcą jest: Tuus Imago Michał Kowalski (lub wpisz swoją
        dokładną formę prawną) z siedzibą: [adres firmy] NIP: [Twój NIP] REGON:
        [Twój REGON – jeśli masz] e-mail: kontakt@tuusimago.com tel. [Twój numer
        telefonu] (zwana dalej „Sprzedawcą” lub „Usługodawcą”). Korzystanie z
        Serwisu jest równoznaczne z akceptacją niniejszego Regulaminu.
      </p>
      ...
      <p>
        ...
        będący osobą fizyczną dokonującą czynności prawnej niezwiązanej
        bezpośrednio z jej działalnością gospodarczą lub zawodową. Usługa –
        wykonanie i wysyłka nadruku na płótnie malarskim na podstawie
        przesłanego przez Klienta pliku graficznego (zdjęcia). Materiał Klienta
        – plik graficzny (zdjęcie) przesłany przez Klienta do Serwisu.
      </p>
      ...
      <p>
        ...
        dokonaniu płatności zamówienie zostaje przyjęte do realizacji. Czas
        realizacji wynosi od 5 do 14 dni roboczych od zatwierdzenia podglądu
        przez Klienta.
      </p>
      ...
      <p>
        ...
        wystawiana jest faktura VAT (wysyłana drogą elektroniczną).
      </p>
      ...
      <p>
        ...
        praw autorskich, praw do wizerunku lub dóbr osobistych osób trzecich.
        Sprzedawca zastrzega sobie prawo odmowy realizacji zamówienia w
        przypadku uzasadnionego podejrzenia naruszenia prawa (m.in. treści
        pornograficzne, przemoc, rasizm, chronione znaki towarowe). Sprzedawca
        nie ponosi odpowiedzialności za treść przesłanych materiałów.
      </p>
      ...
      <p>
        ...
        pełną kwotę. Różnice kolorystyczne wynikające z kalibracji monitora
        Klienta nie stanowią podstawy reklamacji (informacja wyświetlana przed
      ...
      <p>
        ...
        specyfikacji konsumenta lub służących zaspokojeniu jego
        zindywidualizowanych potrzeb. Każde płótno jest drukowane na
        indywidualne zamówienie Klienta – w związku z tym prawo do odstąpienia
        od umowy w terminie 14 dni jest wyłączone.
      </p>
      ...
      <p>
        ...
        https://tuusimago.com/polityka-prywatnosci.
      </p>
