...
export function CookiesContent() {
  return (
    <>
      <h2>§ 1 Co to są pliki cookies i po co ich używamy?</h2>
      <p style={pStyle}>
        Pliki cookies (tzw. ciasteczka) to małe pliki tekstowe zapisywane na
        Twoim urządzeniu (komputer, telefon, tablet). Dzięki nim strona działa
        szybciej i wygodniej.
      </p>

      <h2>§ 2 Jakich cookies używamy na tuusimago.com?</h2>
      <table
        style={{
          width: "100%",
      ...
      <h2>§ 3 Czy mogę wyłączyć cookies?</h2>
      ...
      <h2>§ 4 Jak zarządzać cookies w przeglądarce?</h2>
      <ul style={{ marginTop: 8, marginBottom: 12, paddingLeft: 20 }}>
        <li>
      ...
      <h2>§ 5 Piksel Facebooka / Meta Pixel i Google Analytics</h2>
      <p style={pStyle}>
      ...
      <h2>§ 6 Gdzie są przechowywane dane z cookies?</h2>
      <p style={pStyle}>
      ...
      <h2>§ 7 Kontakt i zmiana ustawień</h2>
      <p style={pStyle}>
